...
void loopDisplayLoc(){
  ...
  // Print time adjusted for ZD at top of main code
  display.print("Time: ");
  ...
  if (gpsSecond < 10) { display.print('0'); }
  display.println(gpsSecond);

  display.println("        DDMM.mm");
  display.print("lat   : "); display.println(gpsLatitude,4); 
  display.print("lon   : "); display.println(gpsLongitude,4);
