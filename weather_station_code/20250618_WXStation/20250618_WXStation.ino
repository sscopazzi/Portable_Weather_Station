...
const char filename[] = "20250620_DecimalDegrees.txt";
int ZD = -7; // - for West
...
int displayMode = 1;  // 0 everything, 1 Location only
...
SdFat SD;
FsFile dataFile; // needs to bs FsFile and not File32, to prevent errors 
...
#include "Adafruit_SHT4x.h" //Adafruit SHT4 Library
...
void loopLOC(){
  ...
  while (millis() - waitStart < 200) { //10000 is 10s
...
#include "Adafruit_BMP3XX.h" //Adafruit BMP3XX Library
